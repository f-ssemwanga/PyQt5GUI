...
class CalculatorUi(QtWidgets.QMainWindow):
    ...
    '''Constructor'''
    def __init__(self):
        super(CalculatorUi, self).__init__() #call to the inherited class' constructor method
        uic.loadUi('logonScreenCalc.ui',self) #loads the uic file 
